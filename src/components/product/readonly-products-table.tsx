...
export function ReadonlyProductsTable({ products, initializing }: ReadonlyProductsTableProps) {
  ...
  return (
    <div className="space-y-3">
      {/* Desktop/Table view */}
      <div className="hidden md:block rounded-lg border border-gray-200 bg-white shadow-sm max-h-[50vh] overflow-auto">
